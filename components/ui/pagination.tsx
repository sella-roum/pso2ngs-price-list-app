...
const PaginationPrevious = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
  <PaginationLink aria-label="前のページへ" size="default" className={cn("gap-1 pl-2.5", className)} {...props}>
...
const PaginationNext = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
  <PaginationLink aria-label="次のページへ" size="default" className={cn("gap-1 pr-2.5", className)} {...props}>
    <span>次へ</span>
